  ...
  return (
    <>
      <button
        ...
        className="flex w-full items-center gap-2.5 rounded-[8px] border border-green-200 bg-green-50 px-3 py-2 text-left transition-colors duration-100 hover:bg-green-100"
      >
        <Mail className="h-4 w-4 shrink-0 text-green-600" strokeWidth={2} />
        <span className="truncate text-[13px] font-medium text-green-800 opacity-0 transition-opacity duration-150 group-hover/sidebar:opacity-100">
          Invite a colleague
        </span>
      </button>
