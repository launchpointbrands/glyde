  ...
  if (!note && !pending && !error) {
    return (
      <button
        type="button"
        onClick={load}
        className="group/ask mt-2 inline-flex items-center gap-1.5 rounded-full border border-green-200 bg-green-50 px-3 py-1 text-[12px] font-medium text-green-600 transition-[background-color,box-shadow] duration-200 hover:bg-green-100 hover:shadow-[0_0_0_3px_var(--color-green-100)]"
      >
        <Sparkles
